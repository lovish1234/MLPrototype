...
def test(primaryDataSet, helperDataSet, primaryClass, helperClass, primaryInstances, helperInstances):
    ...
    modelFolder = resultDir + 'models/crossDataSetMMD'+'/'+primaryDataSet+'/'
    ...
    for iteration in range(iterations):
        ...
        if iteration==(iterations-1):
            ...
            plotFolder = resultDir+'results'+'/'+'crossDataSetMMD/samples'+'/'+primaryDataSet+'/'
    ...
    resultFolder = resultDir+'results/crossDataSetMMD'+'/'+'compressed'+'/'+primaryDataSet+'/'
