...
def getFakeData(primaryDataSet, helperDataSet, fakeClasses, instances, mmdFlag = 0, numHelperInstances=1000):
    ...
    if mmdFlag==1:
        dataFolder = resultDir+'results/crossDataSetMMD/compressed/'+primaryDataSet
...
def plotConfusionMatrix(dataSet,
    ...
    plotFolderName = 'plots/crossDataSetMMD/cm'+'/'+dataSet+'/'
...
def plotAccuracyBar(dataSet,
    ...
    plotFolderName = 'plots/crossDataSetMMD/accuracy'+'/'+dataSet+'/'
    checkAndCreateFolder(plotFolderName)
    ...
    accuracyFolderName = 'plots/crossDataSetMMD/accuracyValues'+'/'+dataSet+'/'
