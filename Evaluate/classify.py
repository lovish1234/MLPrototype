...
def plotConfusionMatrix(dataSet,
    ...
    plotFolderName = 'plots/MMD/cm'+'/'+dataSet+'/'
    checkAndCreateFolder(plotFolderName)
...
def plotAccuracyBar(dataSet,
    ...
    plotFolderName = 'plots/MMD/accuracy'+'/'+dataSet+'/'
    checkAndCreateFolder(plotFolderName)
    ...
    accuracyFolderName = 'plots/MMD/accuracyValues'+'/'+dataSet+'/'
...
if __name__=='__main__':
    ...
    dataSets = ['MNIST','FashionMNIST','CIFAR','SVHN']
