...
if __name__ == '__main__':
    ...
    # taking 20 samples in both the domains A and B
    # with the dimension of 2
    m = 20
    n = 20
    d = 2

    # define mean and variance for both the distributions
    sigma2X = np.eye(d)
    muX = np.zeros(d)
    ...
    # define both as multivariate Gaussian distributions
