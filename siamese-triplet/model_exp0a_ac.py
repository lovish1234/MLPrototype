...
class Discriminator(nn.Module):
    def __init__(self, numLabels):
        ...
        self.layer1 = nn.Linear(400, 128)
        self.layer1Label = nn.Linear(numLabels,128)
        ...
        self.layer4Classify = nn.Linear(64,10)
    ...
    def forward(self, x, c):
        ...
        f = F.sigmoid(self.layer4(x))
        c = F.softmax(self.layer4Classify(x))
        
        return f.view(-1,1), c.view(-1,10)
